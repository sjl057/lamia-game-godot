...
void initialize_lamia_game_utils_module(ModuleInitializationLevel p_level)
{
    ...
    {
        BIND_CORE_ENUM_CONSTANT(LGU_PROPERTY_HINT_DATABASE_ID_SELECT);
        BIND_CORE_ENUM_CONSTANT(LGU_PROPERTY_HINT_DATABASE_SELECT);
        BIND_CORE_ENUM_CONSTANT(LGU_PROPERTY_HINT_MAX);
    }
